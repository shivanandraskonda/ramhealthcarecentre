...
// Example $address = "john@yourdomain.com";

//$address = "rajurastogi@mymail.com";
$address = "marketing@paramountinfinet.com";
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo 'Unable to do sent your email. Can you do whatsapp chat with us';
